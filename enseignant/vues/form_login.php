              ...
              <div class="p-5">
                ...
                <form method="post" action="" class="user">
                  <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="login_etd" name="login_ens" placeholder="login...">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control form-control-user" id="mdp_etd" name="mdp_ens" placeholder="Mot de passe">
                  </div>
                  <div class="form-group">
